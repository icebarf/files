...
static const char col_gray3[]       = "#c9d6f0"; /* this and */
static const char col_gray4[]       = "#c9d6f0"; /* this both handle text color */
static const char col_cyan[]        = "#1a2126"; /* Border Window */
