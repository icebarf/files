...
#else
static const char *fonts[]               = { "mononoki-regular Nerd Font Complete Mono:size=12" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "mononoki-regular Nerd Font Complete Mono:size=12";

static char c000000[]                    = "#000000"; // placeholder value

#if BAR_FLEXWINTITLE_PATCH
#endif // BAR_FLEXWINTITLE_PATCH
static char normfgcolor[]                = "#98c379";
...
static char titlenormfgcolor[]           = "#282c34"; /* #282c34 */
static char titlenormbgcolor[]           = "#e06c75"; /* #282c34 */
static char titlenormbordercolor[]       = "#21252b";
static char titlenormfloatcolor[]        = "#db8fd9";

static char titleselfgcolor[]            = "#282c34"; /* #ccc33f */
static char titleselbgcolor[]            = "#e5c07b"; /* #21252b */
static char titleselbordercolor[]        = "#444444";
static char titleselfloatcolor[]         = "#005577";

static char tagsnormfgcolor[]            = "#e5c07b";
static char tagsnormbgcolor[]            = "#282c34";
static char tagsnormbordercolor[]        = "#444444";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#be5046";
...
static Key keys[] = {
    ...
    /* Screenshots */
    { 0,                            XK_Print,  spawn,          SHCMD("maim --format=\"png\" --hidecursor\
                                                                    --capturebackground\
                                                                    ~/Pictures/Screenshots/$(date +%s).png\
                                                                    ")},

    { ShiftMask,                    XK_Print,  spawn,          SHCMD("maim --select --format=\"png\" --hidecursor\
                                                                     --capturebackground \
                                                                     ~/Pictures/Screenshots/$(date +%s).png\
                                                                    ")},
    /* systemd */
    ...
    {MODKEY|ShiftMask,              XK_w,       spawn,          SHCMD("pcmanfm")},
